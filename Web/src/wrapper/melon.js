...
// var getFundData = spoke => JSON.parse(localStorage.getItem('fund'))[spoke];
...
// var getManagerFromLocalStorage = async () => await getManagerFromPrivateKey(localStorage.getItem('privateKey'));
...
//   var manager = await getManagerFromLocalStorage();
