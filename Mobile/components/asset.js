...
export default class Asset extends Component {
  render() {
    ...
    return <TouchableOpacity onPress={() => goTo('Asset', { symbol, name, balance })} style={{ borderBottomColor: 'lightgrey', borderBottomWidth: 1, height: 100, flexDirection: 'row', padding: 16 }}>
